...
export default function WorkerBeforeUploadPage() {
  ...
  return <WorkerMediaUploadForm mode="before" report={report} reportRef={reportRef} workerId={workerId} workerName={workerName} />;
}
